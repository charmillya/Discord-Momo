...
class cMiraLevel(commands.Cog):
    ...
    async def miralevel(
        ...
        if user and user.id == 1326586963603619995:
            await inter.response.send_message(f'''Oops! I have **no Mira Level** {emotes["emoteMiraLevel"]}, I'm Momo, **not a stylist! {emotes["emoteNikkiWink"]}**''')
        else:
